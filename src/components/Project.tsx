    ...
    <>
      <button
        ...
        className={classNames(
          project.id === "portal"
            ? "animate-pulse shadow-[0_0_20px_10px_rgba(255,255,255,0.9)]"
            : "project-border-shadow",
          "mt-4 cursor-pointer rounded-xl border-2 border-white bg-black transition-all duration-150 ease-linear",
        )}
      >
        <img
          src={thumbImg}
